...
enum { NetSupported, NetWMName, NetWMState, NetWMCheck,
       NetSystemTray, NetWMSticky, NetSystemTrayOP, NetSystemTrayOrientation, NetSystemTrayOrientationHorz,
...
static void togglewallpaper(const Arg *arg);
