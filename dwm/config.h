...
const char gl_wallpaper_frag[] = "/usr/local/share/dwm/ps3xmbfrag.glsl";
const char gl_wallpaper_vert[] = "/usr/local/share/dwm/ps3xmbvert.glsl";
static const int sidepad            = 10;       /* horizontal padding of bar */
static const int vertpad            = 10;       /* vertical padding of bar */
static const char *const autostart[] = {
	"slstatus", NULL,
	"feh", "--bg-scale", "/usr/local/share/dwm/background.png",
	NULL /* terminate */
};
/* tagging */
...
static const char *dmenupctlcmd[] = { "dmenu_playerctl", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_o,      spawn,          {.v = dmenupctlcmd } },
